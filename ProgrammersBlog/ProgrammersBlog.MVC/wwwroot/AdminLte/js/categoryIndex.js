                        ...
                        success: function (data) {
                            ...
                            if (categoryListDto.ResultStatus === 0) {
                                ...
                                $.each(categoryListDto.Categories.$values,
                                    ...
                                    <td>
                                <button class="btn btn-primary btn-sm btn-block btn-update" data-id="${category.ıd}"><span class="fas fa-edit"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete btn-block" data-id="${category.ıd}"><span class="fas fa-minus-circle"></span></button>
                                    </td>
                                            </tr>`;
                                    });
            ...
            function (event) {
                ...
                $.post(actionUrl, dataToSend).done(function (data) {
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `
                                <tr name="${categoryAddAjaxModel.CategoryDto.Category.ıd}">
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.ıd}</td>
                                     ...
                                     <td>
                                <button class="btn btn-primary btn-sm btn-block btn-update"data-id="${categoryAddAjaxModel.CategoryDto.Category.ıd}" ><span class="fas fa-edit"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete btn-block" data-id="${categoryAddAjaxModel.CategoryDto.Category.ıd}"><span class="fas fa-minus-circle"></span></button>
                                    </td>
                                                </tr>`;
            ...
            function (event) {
                ...
                $.post(actionUrl, dataToSend).done(function (data) {
                    ...
                    if (isValid) {
                        placeHolderDiv.find('.modal').modal('hide');
                        const newTableRow = `
                               <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.ıd}">
                                                    <td>${categoryUpdateAjaxModel.CategoryDto.Category.ıd}</td>
                            ...
                            .CategoryDto.Category.IsDeleted ? "Evet" : "Hayır"}</td>
                                ...
                                .ModifiedByName}</td>
                                                        <td>
                                <button class="btn btn-primary btn-sm btn-block btn-update"data-id="${categoryUpdateAjaxModel.CategoryDto.Category.ıd}" ><span class="fas fa-edit"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete btn-block" data-id="${categoryUpdateAjaxModel.CategoryDto.Category.ıd}"><span class="fas fa-minus-circle"></span></button>
                                    </td>
                                                </tr>`;
                        const newTableRowObject = $(newTableRow);
                        const categoryTableRow = $(`[name="${categoryUpdateAjaxModel.CategoryDto.Category.ıd}"]`);
                        newTableRowObject.hide();
