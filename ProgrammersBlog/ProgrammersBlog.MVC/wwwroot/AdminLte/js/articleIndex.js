                                ...
                                $.each(articleResult.Data.Articles.$values,
                                    function (index, article) {
                                        ...
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            `
                                <a class="btn btn-primary btn-sm btn-update" href="/Admin/Article/Update?article%C4%B1d=${newArticle.ıd}"><span class="fas fa-edit"></span></a>
                                <button class="btn btn-danger btn-sm btn-delete" data-id="${newArticle.ıd}"><span class="fas fa-minus-circle"></span></button>
                                            `
                                        ]).node();
                                        const jqueryTableRow = $(newTableRow);
                                        jqueryTableRow.attr('name', `${newArticle.ıd}`);
                                    });
                                dataTable.draw();
                                $('.spinner-border').hide();
