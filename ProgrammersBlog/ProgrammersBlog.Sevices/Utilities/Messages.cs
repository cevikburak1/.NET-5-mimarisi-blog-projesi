...
namespace ProgrammersBlog.Sevices.Utilities
{
    public static class Messages
    {
                    ...
                    public static string NotFound(bool isPlural)
        {
            ...
            {
                return $"{categoryName} adlı kategori başarı ile eklendi";
            }
            ...
            {
                return $"{categoryName} adlı kategori başarı ile Veri Tabanından  silindi";
            }

            public static string UndoDelete(string categoryName)
            {
                return $"{categoryName} adlı kategori başarı ile arşivden geri getirilmiştir";
            }
        }
        ...
        public static class Article
        {
            ...
            {
                return $"{articleTitle} başlıklı makale başarı ile arşivden geri getirilmiştir";
            }

            public static string IncreaseViewCountAsync(string articleTitle)
            {
                return $"{articleTitle} başlıklı makale'nin okunma sayısı başarı ile artırılmıştır";
            }
        }
        ...
        public static class Comment
        {
            ...
            public static string Approve(int commentıd)
            {
                return $"{commentıd}, no'lu yorumunuz başarıyla onaylanmıştır.";
            }
            ...
            {
                return $"{createdByName} adlı Yorum başarı ile arşivden geri getirilmiştir";
            }
        }
    }
}
